...
static int is_jump (unsigned long);
static int check_short_loop (int, fixS *);
  ...
  while (1)
    {
	  ...
	  && insn.insn_mo->pinfo != INSN_MACRO
  	  && OPCODE_IS_MEMBER (insn.insn_mo,
			       ...
			       mips_opts.arch)
	  && (mips_opts.arch != CPU_R5900 || (insn.insn_mo->pinfo & FP_D) == 0)
...
#define OPTION_M5900 (OPTION_MISC_BASE + 13)
  {"m5900", no_argument, NULL, OPTION_M5900},
#define OPTION_NO_M5900 (OPTION_MISC_BASE + 14)
  {"no-m5900", no_argument, NULL, OPTION_NO_M5900},
#define OPTION_WARN_SHORT_LOOP (OPTION_MISC_BASE + 15)
  {"mwarn-short-loop", no_argument, NULL, OPTION_WARN_SHORT_LOOP},
#define OPTION_NO_WARN_SHORT_LOOP (OPTION_MISC_BASE + 16)
  {"mno-warn-short-loop", no_argument, NULL, OPTION_NO_WARN_SHORT_LOOP},
#define OPTION_SINGLE_FLOAT (OPTION_MISC_BASE + 17)
  {"msingle-float", no_argument, NULL,  OPTION_SINGLE_FLOAT},
#define OPTION_NO_SINGLE_FLOAT (OPTION_MISC_BASE + 18)
  {"no-msingle-float", no_argument, NULL, OPTION_NO_SINGLE_FLOAT},

  /* ELF-specific options.  */
#ifdef OBJ_ELF
#define OPTION_ELF_BASE    (OPTION_MISC_BASE + 19)
